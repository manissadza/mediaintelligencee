...
GEMINI_API_KEY = "AIzaSyBRFiXMsnyFUd1mDNYfEqb1L7NP-k4ibR0" # Updated with the provided API Key
...
def get_gemini_insight(prompt_text):
    ...
    # This URL is for Google's Generative Language API.
    # The 'GEMINI_API_KEY' must be a valid API key for this service.
    ...
    try:
        ...
        return f"Error calling Gemini API: {e}. Please ensure your API key is valid for the Google Generative Language API and check your network connection."
...
<style>
    ...
    /* Style for sections to mimic React app's background and shadow */
    div.st-emotion-cache-1pxpz7d.e1f1d6gn2 { /* Targets the main block container in Streamlit */
        background-color: white;
        border-radius: 0.75rem; /* rounded-xl */
        box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05); /* shadow-xl */
        padding: 2rem; /* p-8 */
    }
    /* Specific styles for chart sections */
...
st.markdown("""
Please upload a CSV file with the following columns: <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Date</code>, <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Platform</code>, <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Sentiment</code>, <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Location</code>, <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Engagements</code>, <code style="background-color:#e2e8f0; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-family: monospace;">Media Type</code>.
""", unsafe_allow_html=True)
